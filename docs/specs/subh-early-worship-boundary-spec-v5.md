# Subh Suhoor Boundary and Before-Fajr Window Specification v5 — June 1 Early-Awake and Boundary Reconciliation

| Field | Value |
| --- | --- |
| Canonical filename | `subh-early-worship-boundary-spec-v5.md` |
| Version | 5 |
...
post-Suhoor Fajr slider activations stop no later than 5 minutes before Fajr ends.
...
## June 1 Addendum: Early-Awake Availability

Early-awake actions are available before active wake windows when the focused morning is Today Morning and the relevant wake status is unresolved.

MVP availability:

| Wake purpose | Early-awake action | Availability |
| --- | --- | --- |
| Suhoor | **I’m Already Awake for Suhoor** | Midnight until Suhoor window begins |
| Fajr | **I’m Already Awake for Fajr** | Midnight until Fajr begins |

Future robust rule: derive availability from whether a future wake session/event exists and is not active, to support high-latitude or unusual-night cases.

Both actions require confirmation before silencing/cancelling alarms.
