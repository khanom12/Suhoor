# Subh Planning Horizon, Day Resolution, and Intention Anchoring Specification v5 — June 1 Historical Logging Boundary Alignment

| Field | Value |
| --- | --- |
| Canonical filename | `subh-planning-horizon-day-resolution-intention-anchoring-spec-v5.md` |
| Version | 5 |
...
## June 1 Addendum: Historical Log Records Are Separate From Planning Records

Historical Fajr and fasting logs are durable records, but they are not the same as future morning planning records.

- Planning records answer: what should Subh do for a future/current morning?
- Wake outcome records answer: did the user wake for Suhoor/Fajr?
- Prayer/fast logs answer: did the user pray Fajr or complete the fast?
- Qada candidates answer: did an explicit ✕ create future make-up relevance?

Displaying historical rows must not create planning records. Editing a historical row updates the associated log record and any Qada candidate/review state.
