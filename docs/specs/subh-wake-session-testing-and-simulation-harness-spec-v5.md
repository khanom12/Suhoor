# Subh Wake Session Testing, Simulation, and Real Alarm Validation Harness Spec v5 — May 31 Morning State Framework Update

| Field | Value |
| --- | --- |
| Canonical filename | `subh-wake-session-testing-and-simulation-harness-spec-v5.md` |
| Version | 5 |
| Spec status | Active testing and simulation harness specification |
| Date | 2026-05-31 |
| Supersedes | `subh-wake-session-testing-and-simulation-harness-spec-v4.md` |
...
- action-branching while simulated time is active, including purpose switching, slider adjustment, Quiet confirmation, Next 7 Quiet toggle, `I’m awake`, `I’m Awake for Fajr`, `I prayed Fajr`, late Fajr logging, and optional Fajr follow-up after Suhoor;
...
| MSF-010 | Optional Fajr follow-up | User opts in; normal Fajr wake checks are generated. |
...
| MSF-014 | Late Fajr log same day | Prompt below context card says `I Prayed Fajr Earlier Today`. |
