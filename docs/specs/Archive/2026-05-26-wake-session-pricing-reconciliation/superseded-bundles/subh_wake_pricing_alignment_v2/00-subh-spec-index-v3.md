...
| Version | 3 |
| Spec status | Canonical working index for this aligned bundle; updated for Pricing v3 |
...
| `subh-pricing-entitlement-spec-v3.md` | Pricing, entitlement, paywall doctrine, downgrade/data-preservation rules; Free + Plus model aligned to Wake Sessions and immediate MorningLogs. |
...
```text
Core wake planning, Wake Sessions, core Wake Checks, immediate awake confirmation, current-morning check-ins, Quiet, Next 7 Days, and Weekly Fajrcast
        ↓
Free core utility

Durable history, historical editing, Qada ledgers, summaries, trends, export/sync, and advanced accountability
        ↓
Plus memory and insight layer
```

Pricing must not make a core wake-execution behavior paid-only. Plus may expose and interpret accumulated records over time.
