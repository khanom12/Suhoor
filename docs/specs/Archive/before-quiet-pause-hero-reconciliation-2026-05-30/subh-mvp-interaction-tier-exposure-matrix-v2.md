...
2. The active MVP quick modes are `Suhoor | Fajr | Quiet`.
...
| D | S035-S045 | Home hero: Suhoor mode and intention | Free/core | Same | Suhoor is the only exposed before-Fajr MVP wake mode and is Free. |
