...
| Field | Value |
| --- | --- |
| Canonical filename | `subh-mvp-interaction-inventory-v3.md` |
| Version | 3 |
| Spec status | Source-of-truth stabilized MVP inventory; pre-implementation-audit draft |
| Supersedes | Archive/subh_mvp_interaction_inventory_v2.md |
| Related specs | `00-subh-spec-index-v1.md`, `subh-morning-resolution-contract-state-ownership-spec-v2.md`, `subh-quick-wake-mode-intent-mutation-contract-v1.md`, `subh-alarm-detail-view-screen-spec-v7.md`, `subh-morning-hero-item-spec-v14.md`, `subh-alarm-delivery-schedule-reliability-spec-v2.md` |
...
This v3 inventory preserves the complete MVP interaction universe from v2 while stabilizing terminology, ownership, and spec-coverage status.
...
26. Future edits are saved and later hydrate Home and Next 10 when the date approaches.
...
5. Apply anchored intentions and date-specific overrides from Home, Day Detail, Next 10, Month browsing, or Adjusted Days.
...
| I | S074–S080 | Collapsed Next 10 Mornings | Next 10 Mornings Spec; New Home Screen Composition Spec | Alarm Detail; Morning Resolution; Planning Horizon; Day Purpose | Partially covered — Home composition missing | Next 10 card behavior exists; Home composition must own placement/collapse/routing. |
| J | S081–S088 | Day Detail entry and viewing | Alarm Detailed View Spec | Home Composition; Next 10; Month Browsing; Adjusted Days; Day Purpose | Partially covered — entry routes missing | Alarm Detail exists; missing surfaces must define routes into it. |
...
| P | S135–S143 | Monthly day list and future edits | New Month Browsing and Monthly Day List Spec | Planning Horizon; Morning Resolution; Alarm Detail; Alarm Delivery Reliability | Missing / partially covered | Define future override persistence, hydration into Home/Next 10, and active scheduled horizon handoff. |
...
| AB | S226–S235 | Rapid and repeated interactions | New Quick Wake Mode Contract; Morning Resolution Contract | Morning Hero; Alarm Detail; Next 10; Home Composition; Alarm Delivery Reliability | Partially covered — needs interaction stress tests | Define idempotency, rapid mutation ordering, final-state persistence, and no duplicate scheduling/state records. |

---

## 7. Scenario inventory

Each scenario below is preserved from v2 and reconciled to v3 terminology. Scenario IDs are intentionally unchanged.
...
Primary owning spec: Next 10 Mornings Spec; New Home Screen Composition Spec
...
Implementation status: **Not audited**
Completion needed: Next 10 card behavior exists; Home composition must own placement/collapse/routing.
...
Primary owning spec: Alarm Detailed View Spec
Supporting specs: Home Composition; Next 10; Month Browsing; Adjusted Days; Day Purpose
...
Spec coverage status: **Missing / partially covered**
Implementation status: **Not audited**
Completion needed: Define future override persistence, hydration into Home/Next 10, and active scheduled horizon handoff.
...
Supporting specs: Morning Hero; Alarm Detail; Next 10; Home Composition; Alarm Delivery Reliability
...
| Next 10 Mornings | Reference Home Composition for placement/collapse context; keep compact tag suppression separate from domain meaning. |
...
```text
Review the current Subh codebase against `subh-mvp-interaction-inventory-v3.md` and `00-subh-spec-index-v1.md`. For each scenario ID S001-S235, classify implementation status as Implemented, Partially Implemented, Missing, Risky, or Not Testable Yet.
