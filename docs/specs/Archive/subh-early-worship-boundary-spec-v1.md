...
| Field | Value |
| --- | --- |
| Canonical filename | `subh-early-worship-boundary-spec-v1.md` |
| Version | 1 |
| Spec status | Draft; canonical Desktop working spec |
| Supersedes | None recorded in the active Desktop set |
| Related specs | `00-subh-spec-index-v1.md`, `subh-morning-resolution-contract-state-ownership-spec-v2.md`, `subh-fajr-time-calculation-determination-selection-spec-v1.md`, `subh-quick-wake-mode-intent-mutation-contract-v1.md`, `subh-morning-hero-item-spec-v14.md` |
...
### 10.1 10-day wake forecast

The 10-day wake forecast should remain simple.
...
- the 10-day wake forecast row layout;
