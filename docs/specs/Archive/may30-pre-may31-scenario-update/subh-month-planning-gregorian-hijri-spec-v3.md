# Subh Month Planning, Gregorian/Hijri Browsing, and Day Detail Routing Specification v3 — May 30 Reconciled

| Field | Value |
| --- | --- |
| Canonical filename | `subh-month-planning-gregorian-hijri-spec-v3.md` |
| Version | 3 |
...
Middle-lane tags follow `subh-shared-day-tag-presentation-contract-v2.md`.
