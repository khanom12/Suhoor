# Subh Quiet Morning and Pause Contract Specification v4 — June 1 Quiet vs Early-Awake Reconciliation

| Field | Value |
| --- | --- |
| Canonical filename | `subh-quiet-mode-quiet-morning-contract-spec-v4.md` |
| Version | 4 |
...
## June 1 Addendum: Quiet Is Not Early-Awake

Quiet and early-awake are distinct:

| Action | Meaning | Outcome |
| --- | --- | --- |
| Quiet | User does not want Subh to wake them for that morning. | Delivery suppressed; no wake success logged. |
| **I’m Already Awake for Suhoor** | User is already awake for Suhoor before the active Suhoor window. | Suhoor wake success logged as early; Suhoor attempts silenced; Fajr adhan remains. |
| **I’m Already Awake for Fajr** | User is already awake for Fajr before Fajr begins. | Fajr wake success logged as early; Fajr adhan/alarm/checks silenced. |

Quiet must not create prayer/fast non-completion records. Early-awake must not log Fajr prayer or fast completion.
