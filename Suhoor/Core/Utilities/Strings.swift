...
enum Strings {
    enum AlarmList {
        ...
        static let scheduleUnable = "Wake view couldn’t load. Tap to retry."
    ...
    enum AlarmsTab {
        ...
        static let emptySubtitle = "Use Plans to set your default morning plan or add special days."
        ...
        static let reminderLabel = "Wake reminder"
        ...
        static let suhoorAlarmLabel = "Wake Alarm"
        static let reminderAlarmLabel = "Wake Reminder"
        static let dayDisabledHelper = "If off, no wake events will run on this date."
        static let dayEnableToConfigureHelper = "Turn on \"Enable this day\" to configure this morning."
        static let resetDayTitle = "Reset this morning to defaults?"
        static let resetDayMessage = "This removes day-specific edits and restores the default morning plan you saved during onboarding or in Plans."
        static let suhoorTime = "Wake time"
        ...
        static let resetDay = "Reset this morning to defaults"
        static let resetDayHelper = "Restores the default morning plan and removes any edits made just for this date."
        ...
        static let sourceDayExclusionHelper = "Keeps the plan, but leaves this specific date out."
        static let sourceDeleteDay = "Delete this planned morning"
        static let sourceDeleteDayHelper = "Removes this one manually added morning."
        static let defaultsSection = "Default Morning Plan"
        static let suhoorMode = "Wake timing mode"
        ...
        static let nextAlarmSectionTitle = "Next wake events"
        ...
        static func alarmCountAccessibility(_ count: Int) -> String {
            "\(count) scheduled morning\(count == 1 ? "" : "s") in this month"
        }
    ...
    enum AddSchedule {
        static let title = "Plan Mornings"
        static let modeHelperSingleDay = "Plan one specific date."
        static let modeHelperDateRange = "Plan a span of dates."
        static let modeHelperIslamicDates = "Add common fasting dates using your Hijri corrections."
        static let addDay = "Plan Day"
        static let addRange = "Plan Range"
        static let disabledSingleDay = "This morning is already in your Wake timeline."
        ...
        static let recurringBanner = "Recurring observances fill the next Hijri year automatically, and matching dates are merged."
    ...
    enum LocationRationale {
        ...
        static let body = "Suhoor uses your location to calculate Fajr times for your area and keep your morning plan updated."
    ...
    enum Onboarding {
        static let valueTitle = "Wake in time for Fajr"
        static let valueBody = "Suhoor calculates your local Fajr time and helps you wake in the right relationship to it."
        static let valuePrimaryActionTomorrow = "Set tomorrow’s wake"
        static let valuePrimaryActionToday = "Set today’s wake"
        static let valueSecondaryAction = "Explore the app"

        static let previewFajrLabel = "Fajr"
        static let previewSuhoorLabel = "Wake alarm"
        ...
        static let futureVisualizationTitle = "Your morning plan adapts automatically"
        static let futureVisualizationCardTitle = "Next 5 days"
        static func futureVisualizationOffsetLine(_ minutes: Int) -> String { "Your wake stays \(minutes) minutes before Fajr as Fajr shifts day to day." }
        static func futureVisualizationTableOffset(_ minutes: Int) -> String { "Offset: \(minutes)m before Fajr" }
        static let futureVisualizationFooter = "You can change this anytime in Plans."

        static let permissionsTitle = "Allow Suhoor to wake you up"
        static let permissionsBody = "Alarm access is required so your wake can ring even in Silent Mode."
        ...
        static let permissionsNotificationsRequired = "Suhoor uses notifications to wake you on this device."
        static let permissionsFallbackBanner = "If alarms aren’t available, Suhoor uses notifications as a fallback."

        static let offsetTitle = "How early should we wake you?"
        static let offsetBody = "Choose how much time you want relative to Fajr."
        ...
        static let successBody = "Sleep peacefully tonight.\nSuhoor will keep your next wake aligned with Fajr."
        ...
        enum HowItWorks {
            ...
            static let bulletCustomize = "Adjust any day later in Wake."
        }
    }
    ...
    enum AlarmDetail {
        ...
        static let editAlertDefaults = "Edit default morning plan"
    ...
    enum Settings {
        ...
        static let defaultSuhoorToggle = "Main wake enabled by default"
        static let defaultReminderToggle = "Wake reminder enabled by default"
        static let defaultFajrToggle = "Fajr notice enabled by default"
        static let suhoorTimingSection = "Wake timing"
        static let suhoorTimingHelper = "Applies to the main wake only."
        static let suhoorTimeBasedOn = "Wake time is based on"
        ...
        static let reminderBeforeSuhoorWarning = "Reminder can’t be earlier than your main wake."
        ...
        static let alertsSection = "Wake sequence"
        static let wakeAlarmLabel = "Main wake"
        static let reminderLabel = "Wake reminder"
        static let fajrAdhanLabel = "Fajr adhan"
        ...
        static let wakeAlarmHelper = "Your main wake-up time around Fajr."
        static let reminderSection = "Reminder"
        ...
        static let testAlarmKit = "Run test wake alarm (1 min)"
        static let cancelAlarmKitTest = "Cancel test wake alarm"
        ...
        static let alarmScheduled = "Test wake alarm scheduled for 1 minute from now."
        static let alarmScheduleFailed = "Couldn’t schedule test wake alarm. Check permissions."
