...
enum Strings {
    ...
    enum AddSchedule {
        static let title = "Plan Special Mornings"
        ...
        static let recurringBanner = "Recurring plans fill the next Hijri year. Suhoor schedules upcoming wake events automatically, and matching dates are merged."
