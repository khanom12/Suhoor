...
enum OnboardingPath: String, Equatable, Sendable {
    ...
    var valueBody: String {
        switch self {
        case .ramadan:
            return "Suhoor keeps your wake aligned with local Fajr so you have time to eat, prepare, and begin fasting with confidence."
        case .fajr:
    ...
    func relationshipSentence(_ minutes: Int) -> String {
        switch self {
        case .ramadan:
            return "Suhoor wake \(minutes) min before Fajr."
        case .fajr:
    ...
    func futureVisualizationTableOffset(_ minutes: Int) -> String {
        switch self {
        case .ramadan:
            return "Suhoor wake: \(minutes)m before Fajr"
        case .fajr:
    ...
    var successBody: String {
        switch self {
        case .ramadan:
            return "Your next wake is set before Fajr. Suhoor can support you through suhoor, Fajr, and iftar, then keep supporting your mornings after Ramadan."
        case .fajr:
